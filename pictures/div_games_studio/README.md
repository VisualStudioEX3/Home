...
**DIV Games Studio** if fully functional on [DOSBox](https://www.dosbox.com/). You can download the original DIV1 and DIV2 (and other resources) from https://divcompo.now.sh/recursos as abandoneware.
